            ...
            <div className="space-y-6">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                ...
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  <Button variant="outline" size="sm" onClick={openDevConsole} className="rounded-full h-8 px-4 border-black/10 dark:border-white/10 bg-transparent hover:bg-black/5 dark:hover:bg-white/5">
            ...
            <div className="space-y-3 text-[14px] text-muted-foreground">
              ...
              <div className="flex gap-4 pt-3">
                ...
                <Button
                  variant="link"
                  className="h-auto p-0 text-[14px] text-blue-500 hover:text-blue-600 font-medium"
                  onClick={() => window.electron.openExternal('https://beike.feishu.cn/wiki/V6HQwFM4fitk1zkaHJfc5Z6Enlf?from=from_copylink')}
                >
                  {t('about.faq')}
                </Button>
              </div>
