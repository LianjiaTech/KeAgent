...
description: Generate and edit diagrams including draw.io, Mermaid, and Excalidraw. Use when creating new diagrams from natural language, updating existing .drawio/.mmd/Excalidraw files, or producing flowcharts, sequence diagrams, class diagrams, ER diagrams, mind maps, architecture diagrams, and network topologies.
---
